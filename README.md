...
5. Кнопка Оформление билета (переход на страницу Оформление билета)
...
2. История заказов
3. Список купленных билетов (на активные авиарейсы), для каждого элемента списка кнопка Отменить, Оплатить
4. Список бонусных карт и информация о бонусах
...
На странице размещены:
1. Список всех зарегистрированных пользователей и данные о них (ФИО, email, телефон)
...
- Получение истории заказов пользователя
  - перейти в Профиль (для прошедших регистрацию пользователей)
...
- Добавление клиента
  - Перейти на страницу Добавление профиля
  - Ввести данные
